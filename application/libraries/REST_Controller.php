...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
	...
	// Skip keys test for $config['auth_override_class_method']['class'['method'] = 'none'
        ...
        // time zone
//         $test = $this->input->get_request_header('some-header', TRUE);
//         $requestTimeZone = $this->input->get_request_header('requestTimeZone', TRUE);

//         $requestTimeZone = $this->head('requestTimeZone');
//         if($requestTimeZone) {
...
//         
    ...
    protected function _check_cors()
    {
    	...
    	if ($this->_detect_method() === 'options')
    	{
    		exit;
    	}
    }
